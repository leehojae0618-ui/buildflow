create or replace function public.persist_verification_run(
  p_project_id uuid,
  p_execution_id uuid,
  p_status text,
  p_final_status text,
...
revoke all on function public.persist_verification_run(
  uuid,
  uuid,
  text,
  text,
...
grant execute on function public.persist_verification_run(
  uuid,
  uuid,
  text,
  text,
