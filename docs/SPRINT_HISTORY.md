...
| RECIPE-MANUAL-RUN-001 | First UI-reachable "Recipe 실행" button for the composite AI-news Recipe, gated by a new Server Action boundary that closes a found safety gap (C1/C2 previously had no runtime-level kill switch) (roadmap Steps 7+8) | CLOSED / COMPLETE, browser interaction NOT VERIFIED, LIVE EXECUTION NONE | `acdf0d5` (pushed) | typecheck/lint PASS; 961 tests PASS (+5 tests incl. 2 fetch-spy safety tests), 0 regressions | `sprints/RECIPE-MANUAL-RUN-001/TASK.md`, `sprints/RECIPE-MANUAL-RUN-001/CONTRACT.md`, `sprints/RECIPE-MANUAL-RUN-001/REPORT.md` |
| RECIPE-EXECUTION-PROGRESS-001 | Step-by-step progress checklist for the Manual Run (3 granular, independently-gated Server Actions) (roadmap Step 9) | CLOSED / COMPLETE, browser interaction NOT VERIFIED, LIVE EXECUTION NONE | `9dcdd3c` (pushed) | typecheck/lint PASS; 963 tests PASS (+2 tests), 0 regressions | `sprints/RECIPE-EXECUTION-PROGRESS-001/TASK.md`, `sprints/RECIPE-EXECUTION-PROGRESS-001/REPORT.md` |
| RECIPE-RUN-EVIDENCE-001 | Surface the already-computed LiveRecipeEvidence (services used, real completion time, result) that Manual Run previously discarded (roadmap Step 10) | IMPLEMENTED / VALIDATED, browser interaction NOT VERIFIED, LIVE EXECUTION NONE | pending | typecheck/lint PASS; 963 tests PASS, 0 regressions | `sprints/RECIPE-RUN-EVIDENCE-001/TASK.md`, `sprints/RECIPE-RUN-EVIDENCE-001/REPORT.md` |
