...
| BUILD-PLAN-APPROVAL-DISPLAY-001 | Show a Build Package's cost and required-approvals fields, already computed but never rendered (roadmap Step 5) | IMPLEMENTED / VALIDATED, browser interaction NOT VERIFIED | pending | typecheck/lint PASS; 956 tests PASS, 0 regressions; no live execution | `sprints/BUILD-PLAN-APPROVAL-DISPLAY-001/TASK.md`, `sprints/BUILD-PLAN-APPROVAL-DISPLAY-001/REPORT.md` |
