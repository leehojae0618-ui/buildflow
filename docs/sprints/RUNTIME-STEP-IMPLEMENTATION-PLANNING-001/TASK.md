...
Implementation Approval is REVALIDATED. Runtime Implementation Authority
remains suspended pending explicit regrant. The implemented three-file slice
at `13a2c26` must not change until authority is regranted.
