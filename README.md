...
새 Project를 만들면 Goal Parser가 목표를 Goal Type, Category, Expected Output으로 구조화하고, 필요한 Clarification 질문·Constraint 분류·Consent 요구사항을 Requirement Snapshot으로 저장합니다. 질문의 품질이 설계의 품질을 결정하며, 기존 Recommendation Engine은 호환성을 유지합니다.
