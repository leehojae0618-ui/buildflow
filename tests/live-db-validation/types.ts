...
export type LiveDbSafeErrorCode =
  ...
  | "LIVE_DB_PROJECT_FIXTURE_INPUT_INVALID"
  | "LIVE_DB_PROJECT_FIXTURE_SETUP_FAILED"
  | "LIVE_DB_PROJECT_FIXTURE_READBACK_FAILED"
  | "LIVE_DB_PROJECT_FIXTURE_OWNER_MISMATCH"
