...
export function RecipeFirstExperience() {
  ...
  function submit() { setSelected(null); setSelectedEngine(undefined); setConnectionNotice(null); setTestWriteNotice(null); setAwaitingTestWriteApproval(false); setClarificationAnswers({}); setSubmittedGoal(goal.trim()); }
  function selectRecipe(item: RankedRecipe) { setSelected(item); setSelectedEngine(undefined); setConnectionNotice(null); setTestWriteNotice(null); setAwaitingTestWriteApproval(false); setClarificationAnswers({}); }
...
function BuildPreparation({ buildPackage, onEngineSelect, onStartConnection, connectionNotice, onPrepareTestWrite, onApproveTestWrite, testWriteNotice, awaitingTestWriteApproval, onAnswerClarification, onClose }: { buildPackage: ReturnType<typeof createBuildPackage>; onEngineSelect: (engine: ExecutionEngine) => void; onStartConnection: () => void; connectionNotice: string | null; onPrepareTestWrite: () => void; onApproveTestWrite: () => void; testWriteNotice: string | null; awaitingTestWriteApproval: boolean; onAnswerClarification: (id: string, value: string) => void; onClose: () => void }) {
