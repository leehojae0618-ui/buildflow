...
export type Connector = { providerId: string; providerName: string; status: ConnectionStatus; required: boolean; capabilities: ConnectorCapability[]; credential?: ConnectorCredential };
