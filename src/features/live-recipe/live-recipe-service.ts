...
import { slackWriteRequestSchema, type LiveConnectionState, type LiveRecipeEvidence, type LiveRecipeFailureCode, type LiveRecipeResult, type SlackTestActionPreparation, type SlackWriteRequest } from "./types";
...
function externalFailure(error: unknown): "EXTERNAL_ACTION_FAILED" | "TIMEOUT" {
