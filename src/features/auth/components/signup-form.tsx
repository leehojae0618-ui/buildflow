...
export function SignupForm() {
  ...
  return (
    <div className="space-y-5">
      ...
      <form action={signInWithGoogle}><input type="hidden" name="next" value="/app" /><button type="submit" className="w-full border border-zinc-700 px-4 py-3 text-sm font-medium text-zinc-200 hover:border-cyan-400/50 hover:text-cyan-200">Google로 계속하기</button></form>
